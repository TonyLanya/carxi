                ...
                <div class="trip-detail-page-inner">
            		...
            		<div class="trip-detail-page-right">
              			<div class="driver-info">
                			...
                			<h3><?=$langage_lbl['LBL_RIDER_You_ride_with']; ?> <?= $db_driver[0]['vName']?></h3>
                			...
                			<div class="fare-breakdown-inner">
                  				...
                  				<ul>
									...
									if($db_trip[0]['eFareType'] != 'Fixed')
									{
										...
										<li><strong><?=$langage_lbl['LBL_RIDER_DISTANCE_TXT']; ?> (<?=$db_trip[0]['fDistance'];?>)</strong><b><?=$generalobj->trip_currency($db_trip[0]['fPricePerKM'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
										<li><strong><?=$langage_lbl['LBL_RIDER_TIME_TXT']; ?> (<?echo $diff;?>)</strong><b><?=$generalobj->trip_currency($db_trip[0]['fPricePerMin'],$db_trip[0]['fRatio_'.$tripcurname],$tripcurname);?></b></li>
										<?
									}
									else
									{
