													...
													<? for ($i = 0; $i < count($data_drv); $i++) { ?>
														<tr class="gradeA" >
															...
															<td width="10%" align="center">
																...
																?>
																<?php if($data_drv[$i]['eStatus']!="Deleted"){?> 
																	<a href="<?= $newUrl2; ?>" data-toggle="tooltip" title="Edit Driver Document">
															...
															<td width="20%" align="center">
																...
																?>
																<?php if($data_drv[$i]['eStatus']!="Deleted"){?> 
																	<a href="<?= $newUrl; ?>" data-toggle="tooltip" title="Edit Driver">
																		<img src="img/edit-icon.png" alt="Edit">
																	</a>
																<? }?>
																
																<a href="driver.php?iDriverId=<?= $data_drv[$i]['iDriverId']; ?>&status=inactive" data-toggle="tooltip" title="Active Driver">
																	<img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
																</a>
																<a href="driver.php?iDriverId=<?= $data_drv[$i]['iDriverId']; ?>&status=active" data-toggle="tooltip" title="Inactive Driver">
