...
$sql1="select vTitle_EN,iPetTypeId from  pet_type where eStatus='Active'";
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <select class="form-control" name = 'iUserId' required  id="iUserId" onChange="validate_rider_langcode(this.value)" >
                                                       ...
                                                       <? for($i=0;$i<count($db_res_user);$i++){ ?>
                                                       <option value = "<?= $db_res_user[$i]['iUserId'] ?>" <?if($iUserId==$db_res_user[$i]['iUserId']){?>selected<? }  ?>><?= $db_res_user[$i]['vName'] ?></option>
                                                       <? } ?>
                                                  </select>
                                             </div>
                                        </div>  
