                              ...
                              <div class="form-group">
                                   ...
                                   <form method="post" action="" enctype="multipart/form-data">
                                       ...
                                       <?php if($id){?>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" pattern="[a-zA-Z]+" class="form-control" name="vLastName"  id="vLastName" value="<?= $vLastName; ?>" placeholder="Last Name" required>
                                             </div>
                                        </div>
								...
								<div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  ...
                                                  <input type="text" maxlength="10" pattern="[0-9]{10}" class="form-control" name="vPhone"  id="vContactNo" value="<?= $vContactNo; ?>" placeholder="Phone"  required >
                                             </div>
                                        </div>
