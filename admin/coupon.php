                                   ...
                                   <input type="hidden" name="iCouponId" id="iCouponId" value="{$iCouponId}" />
                                    <input type="hidden" name="action" id="action" value="{$mode}" />
                                        ...
                                        <ul>
                                             ...
                                             <li>
                                                  Validity :<br>
                                                  <input type="radio" name="eValidityType" onclick="showhidedate(this.value)" value="Permanent" <?php if($db_coupon[0]['eValidityType'] == 'Permanent'){ ?> checked <?php }else { ?> checked <? } ?> >
                                                    Permanent
