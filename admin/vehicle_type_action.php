...
?>
									 ...
									 <?php }else{?>
									   <input type="hidden" name="eFareType" value="Regular"/>
										...
										<div id="Regular_div1">
										 <?php// if($APP_TYPE != 'UberX'){ ?>
											<div class="row" id="hide-km">
												 <div class="col-lg-12">
													  <label> Price Per Miles<span class="red"> *</span></label>
												 </div>
												 <div class="col-lg-6">
											...
											<div class="row" id="hide-price">
												 ...
												 <div class="col-lg-6">
													  <!-- <input type="text" class="form-control" name="fPricePerMin"  id="fPricePerMin" value="<?= $fPricePerMin; ?>"   onChange="getpriceCheck(this.value)"> -->                            <input type="text" class="form-control" name="fPricePerMin"  id="fPricePerMin" value="<?= $fPricePerMin; ?>"  >
                                        ...
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <input type="submit" class="save btn-info" name="btnsubmit" id="btnsubmit" value="<?= $action; ?> Vehicle Type" >
                                             </div>
                                        </div>
                                   </form>
                              </div>
