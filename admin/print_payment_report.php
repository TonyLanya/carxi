                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                 <td> 
                        														...
                        														<?
                        															if($iDriverId !=''){
                        															echo $db_trip[0]['vName']." ".$db_trip[0]['vLastName'].",<br/>"; 
                        															}
                        															?>
							  ...
							  <table border="0" width="100%" style=="border-top: 1px solid #000000; border-left: 1px solid #000000;" align="left" cellpadding="3" cellspacing="0">          
                                    ...
                                    <tr>      
                                       <td valign="top" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?=$db_trip[$i]['vRideNo'];?></td>      
                                        <td valign="top" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?=$db_trip[$i]['drivername'];?></td> 
                                        <!--<td valign="top" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?=$db_trip[$i]['passanger'];?></td>--> 
