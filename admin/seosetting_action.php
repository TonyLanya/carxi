						...
						<div class="form-group">
							...
							<form method="post" action=""  enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="vPagetitle" value="<?=$vPagetitle;?>" placeholder="Page Title" required >
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="vMetakeyword" value="<?=$vMetakeyword;?>" placeholder="Meta Keyword" required >
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="tDescription" value="<?=$tDescription;?>" placeholder="Description" required >
									</div>
								</div>							
								<div class="row">
										<div class="col-lg-12">
