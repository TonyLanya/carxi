								...
								<?
									if($count_all > 0) {
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<textarea class="form-control" rows="10" name="<?=$vBody;?>"  id="<?=$vBody;?>"  placeholder="<?=$vLTitle;?> Body" <?=$required;?>> <?=$$vBody;?></textarea>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-lg-12">
											<input type="submit" class="save btn-info" name="submit" id="submit" value="<?=$action;?> Email Template">
										</div>
									</div>
							</form>
						</div>
