														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<td width="10%" align="center">
																	<a href="email_template_action.php?id=<?=$iEmailId;?>" data-toggle="tooltip" title="Edit Email Template">
																...
																<!-- <td width="10%" align="center">
																	<form name="delete_form" id="delete_form" method="post" action="" onsubmit="return confirm_delete()" class="margin0">
																		<input type="hidden" name="hdn_del_id" id="hdn_del_id" value="<?=$iEmailId;?>">
