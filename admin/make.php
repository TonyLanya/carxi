													...
													<?
														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<a href="make.php?iMakeId=<?=$id;?>&status=Active" data-toggle="tooltip" title="Active Driver">
																	<img src="img/active-icon.png" alt="<?php echo $eStatus ?>" >
																</a>
																<a href="make.php?iMakeId=<?= $id; ?>&status=Inactive" data-toggle="tooltip" title="Inactive Driver">
