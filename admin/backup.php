		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					...
					* Note :
					<br />1) Scheduled Backup feature will require to setup a cron job file on server. Without it, this feature cannot work.
					<br />2) In our online demo we have disabled "backup" feature for recurity reason. You will see a sample file.
					<br />3) In our online demo we have disabled "scheduled backup" feature to save our server space and server load.
					</form>
					</div>
