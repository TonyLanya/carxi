                                                  ...
                                                  <div class="panel-body">
                                                       ...
                                                       <?php $file_ext = $generalobj->file_ext($db_user[0]['vLicence']);
                                                                      if($file_ext == 'is_image'){ ?>
                                                                           <img src = "<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vLicence'] ?>" style="width:200px;cursor:pointer;" alt ="YOUR DRIVING LICENCE" data-toggle="modal" data-target="#myModallicence"/>
                                                                      <?php }else{ ?>
                                                                           <a href="<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vLicence']  ?>" target="_blank">Licence DOC</a>
                                                                      <?php } ?>
                                                       <?php } else { ?>
                                                            Licence not found
                                                       <?php } ?>
                                                       <b><button class="btn btn-info" data-toggle="modal" data-target="#uiModal" <? if(SITE_TYPE=='Demo') echo "disabled";?>>
                                             ...
                                             <div class="panel panel-default upload-clicking">
                                                  ...
                                                  <div class="panel-body">
                                                       <?php if ($db_user[0]['vNoc'] != '') { ?>
                                                            ...
                                                            if($file_ext == 'is_image'){ ?>
                                                                 <img src = "<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vNoc'] ?>" style="width:200px;" alt ="NOC not found"/>



														                                  <?php }else{ ?>
                                                                 <a href="<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vNoc']  ?>" target="_blank">NOC DOC</a>
                                                            <?php } ?>
                                                       <?php } else { ?>
                                                            Need to upload</br>
                                                       <?php } ?>
                                                       <b>
                                                       <button class="btn btn-info" data-toggle="modal" data-target="#uiModal_2" <? if(SITE_TYPE=='Demo') echo "disabled";?>>
                                             ...
                                             <div class="panel panel-default upload-clicking">
                                                  ...
                                                  <div class="panel-body">
                                                       <?php if ($db_user[0]['vCerti'] != '') { ?>
                                                            ...
                                                            if($file_ext == 'is_image'){ ?>
                                                                 <img src = "<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vCerti'] ?>" style="width:200px;" alt ="NOC not found"/>
                                                            <?php }else{ ?>
                                                                 <a href="<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vCerti']  ?>" target="_blank">NOC DOC</a>
                                                            <?php } ?>
                                                       ...
                                                       <?php } ?>
                                                       <b>
                                                       <button class="btn btn-info" data-toggle="modal" data-target="#uiModal_3" <? if(SITE_TYPE=='Demo') echo "disabled";?>>
                                                                           ...
                                                                           <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                                                                                     ...
                                                                                     <?php } else { ?>
                                                                                          <?php $file_ext = $generalobj->file_ext($db_user[0]['vLicence']);
                                                                                          if($file_ext == 'is_image'){ ?>
                                                                                               <img src = "<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vLicence'] ?>" style="width:200px;" alt ="Licence not found"/>
                                                                                          <?php }else{ ?>
                                                                                               <a href="<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vLicence']  ?>" target="_blank">Licence DOC</a>
                                                                                          <?php } ?>
                                                                                     <?php } ?>
                                                                                ...
                                                                                <div>
                                                                                     <span class="btn btn-file btn-success"><span class="fileupload-new">Upload License</span>
                                                                 ...
                                                                 <div class="form-group">
                                                                      <div class="col-lg-12">
                                                                           <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                ...
                                                                                <div>
                                                                                     <span class="btn btn-file btn-success"><span class="fileupload-new">Upload Photo</span>
                                                                                          <span class="fileupload-exists">Change</span><input type="file" name="certi"/></span>
                                                                                     <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">Remove</a>
                                                                                </div>
                                                                           </div>
                                                                      </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src = "<?= $tconfig["tsite_upload_driver_doc"] . '/' . $_REQUEST['id'] . '/' . $db_user[0]['vLicence'] ?>" style="width:500px;" alt ="" />
            </div>
