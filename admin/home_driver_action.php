							...
							<form method="post" action="" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<?
											$temp = 1;
											$query1 = mysql_query("SELECT iDisplayOrder FROM ".$tbl_name." WHERE iDriverId = ".$id." ORDER BY iDisplayOrder")or die(mysql_error());
											$dataArray = array();
								...
								if($count_all > 0) {
									...
									<div class="row">
										<div class="col-lg-12">							
											<input type="submit" class="save btn-info" name="submit" id="submit" value="<?=$action;?> Home Page Driver">
										</div>
									</div>
