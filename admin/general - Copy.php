								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<ul class="nav nav-tabs">
											...
											?>
												<li class="<?php echo $activeTab == $newKey?'active':''?>"><a data-toggle="tab" href="#<?=$newKey?>"><?=$key?></a></li>
											<?php
												}
											?>
										</ul>
																...
																<?php
																	...
																	<select class="form-control" name="Data[<?=$value1['vName']?>]">
																		<?php
																			...
																			{
																		?>
																			<option value="<?=$data_cou[$i]['vCountryCode']?>" <?=$selected?> ><?=$data_cou[$i]['vCountry'] . " (+" . $data_cou[$i]['vPhoneCode'] . ") "?></option>
																		<?php
																			}//}																			
																		?>
																	</select>
