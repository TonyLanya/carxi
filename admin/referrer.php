...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
     ...
     <head>
          <meta charset="UTF-8" />
          <title>Admin | Referral Report</title>
                                             ...
                                             <div class="panel-heading">
                                                  <ul class="nav nav-tabs">
													  ...
													  <li <?php if($type=='Rider'){?> class="active" <?php } ?>>
														  <a data-toggle="tab" onclick="getReview('Rider')"  href="#menu1">Passenger</a></li>
												  </ul>
                                             </div>
                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            <thead>
                                                                <tr>
																	...
																	<th width="25%">Total Members Referrred</th>
																...
																for($i=0;$i<count($data_drv);$i++) {																
                                                                 ...
                                                                 <tr class="gradeA">
																	  ...
																	  <?php }else{?>
																	   ...
																	   <td><? echo $data_drv[$i]['Passanger'].' '.$data_drv[$i]['passangerlast']; ?></td>
