...
#echo $default_lang;exit;
	...
	$sql = "SELECT * FROM ".$tbl_name." WHERE vCode = '".$default_lang."' AND lPage_id = '".$pageid."' ORDER BY LanguageLabelId DESC";
	$db_data = $obj->MySQLSelect($sql);
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						...
						<div class="col-lg-12">
							<h2><?= $lp_name; ?> Labels</h2>
							<a href="languages_action.php?lp_id=<?=$pageid;?>&lp_name=<?=$lp_name;?>">
														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<td class="center veh_act" align="center" style="text-align:center;">
																	<a href="languages_action.php?id=<?=$vLabel;?>&lp_id=<?=$pageid;?>&lp_name=<?=$lp_name;?>">
