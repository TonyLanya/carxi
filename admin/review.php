                                             ...
                                             <div class="panel-heading">
                                                  <ul class="nav nav-tabs">
													  <li <?php if($data_drv[0]['reviewtype']=='Driver'){?> class="active" <?php } ?>>
														  <a data-toggle="tab"  onclick="getReview('Driver')"  href="#home" >Driver</a></li>
													  <li <?php if($data_drv[0]['reviewtype']=='Passenger'){?> class="active" <?php } ?>>
														  <a data-toggle="tab" onclick="getReview('Passenger')"  href="#menu1">Passanger</a></li>
												  </ul>
                                             </div>
                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            <thead>
																 ...
																 <th>Ride Number</th>
																	...
																	<?php }else{?>
																	   <th><?php echo $langage_lbl_admin['LBL_PASSANGER_TXT_ADMIN'];?>  Name(Average Rate)</th>
                                                            ...
                                                            <tbody>
																 ...
																 <td width="10%"><?php echo $data_drv[$i]['vRideNo']; ?></td>
                                                                      ...
                                                                      <td width="10%"><? echo $data_drv[$i]['Diver'].' '.$data_drv[$i]['Driverlastname'];
																		  echo " <b>( ".$data_drv[$i]['vAvgRating']." )</b>";
																		  ?></td>
																	  
                                                                      <td width="10%" data-order="<? echo $data_drv[$i]['Passanger']; ?>"><? echo $data_drv[$i]['passangerlast']; ?></td>
																	  <?php }else{?>
																	  <td data-order="<?=$data_drv[$i]['Passanger']; ?>"><? echo $data_drv[$i]['passangerlast']; 
																		   echo " <b>( ".$data_drv[$i]['passangerrate']." )</b>";
																		  ?></td>
																	   <td><? echo $data_drv[$i]['Diver'].' '.$data_drv[$i]['Driverlastname']; ?></td>
                                                                      
																	  <?}?>
																	    <td width="5%" align="center"> <?= $data_drv[$i]['vRating1'] ?> </td>
                                                                     
                                                                    
                                                                      <td align="center" width="10%"> <?= $data_drv[$i]['tDate'] ?> </td>
                                                                      <td align="center" width="50%"> <?= $data_drv[$i]['vMessage'] ?></td>  
																	   <td align="center" width="5%">
																		<a href="javascript:void(0)" onclick="confirm_delete('delete','<?=$data_drv[$i]['iRatingId'] ?>')" data-toggle="tooltip" title="Delete Review">
