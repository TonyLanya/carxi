...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<meta charset="UTF-8" />
		<title>Admin | Home Page Drivers </title>
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2>Home Page Driver </h2>
							<a href="home_driver_action.php">
								<input type="button" value="Add Driver " class="add-btn">
							</a>
						</div>
					</div>
					<hr />
														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<td width="10%" align="center">
																	<? if($iDisplayOrder != 1) { ?>
																		<a href="home_driver.php?id=<?=$iDriverId;?>&flag=up">
																			<button class="btn btn-warning">
																				<i class="icon-arrow-up"></i> 
																			</button>
																		</a>
																		<? } if($iDisplayOrder != $count_all) { ?>
																		<a href="home_driver.php?id=<?=$iDriverId;?>&flag=down">
																			<button class="btn btn-warning">
																...
																<td width="15%" align="center" class="veh_act">
																	<a href="home_driver_action.php?id=<?=$iDriverId;?>">
																		<button class="remove_btn001" data-toggle="tooltip" title="Edit Home Driver">
																			<img src="img/edit-icon.png" alt="Edit">
																		</button>
																	</a>
																	
																	<a href="home_driver.php?iDriverId=<?=$iDriverId;?>&status=Active" data-toggle="tooltip" title="Active Home Driver">
																		<img src="img/active-icon.png" alt="<?php echo $eStatus ?>" >
																	</a>
																	<a href="home_driver.php?iDriverId=<?= $iDriverId; ?>&status=Inactive" data-toggle="tooltip" title="Inactive Home Driver">
																	...
																	<form name="delete_form" id="delete_form" method="post" action="" onSubmit="return confirm_delete()" class="margin0">
																		<input type="hidden" name="hdn_del_id" id="hdn_del_id" value="<?=$iDriverId;?>">
