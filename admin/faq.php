					...
					<div class="row">
						<div class="col-lg-12">
							...
							<a href="faq_action.php">
								<input type="button" value="Add FAQ " class="add-btn">
							</a>
						</div>
					</div>
					<hr />
														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<td width="12%" align="center">
																	<? if($iDisplayOrder != 1) { ?>
																		<a href="faq.php?id=<?=$iFaqId;?>&flag=up">
																			<button class="btn btn-warning">
																				<i class="icon-arrow-up"></i> 
																			</button>
																		</a>
																		<? } if($iDisplayOrder != $count_all) { ?>
																		<a href="faq.php?id=<?=$iFaqId;?>&flag=down">
																			<button class="btn btn-warning">
																...
																<td width="18%"  class=" veh_act">
																	<a href="faq_action.php?id=<?=$iFaqId;?>&faq_cat_id=<?=$iFaqcategoryId;?>">
																		<button class="remove_btn001" data-toggle="tooltip" title="Edit FAQ">
																			<img src="img/edit-icon.png" alt="Edit">
																		</button>
																	</a>
																	
																	<a href="faq.php?iFaqId=<?=$iFaqId;?>&status=Active" data-toggle="tooltip" title="Active FAQ">
																		<img src="img/active-icon.png" alt="<?php echo $eStatus ?>" >
																	</a>
																	<a href="faq.php?iFaqId=<?= $iFaqId; ?>&status=Inactive" data-toggle="tooltip" title="Inactive FAQ">
																	...
																	<form name="delete_form" id="delete_form" method="post" action="" onSubmit="return confirm_delete()" class="margin0">
																		<input type="hidden" name="hdn_del_id" id="hdn_del_id" value="<?=$iFaqId;?>">
