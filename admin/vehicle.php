                                                                           ...
                                                                           <div class="col-lg-12">
                                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                     <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                                                                                          ...
                                                                                          <?php $file_ext = $generalobj->file_ext($db_driver_vehicle[$i]['vInsurance']);
                                                                           ...
                                                                           <div class="col-lg-12">
                                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                     <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                                                                                          ...
                                                                                          <?php $file_ext = $generalobj->file_ext($db_driver_vehicle[$i]['vPermit']);
                                                                                                    if($file_ext == 'is_image'){ ?>
                                                                      ...
                                                                      <div class="form-group">
                                                                           <div class="col-lg-12">
                                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                     <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                                                                                          <? if($db_driver_vehicle[$i]['vRegisteration'] != ''){ ?>
                                                                                          <?php $file_ext = $generalobj->file_ext($db_driver_vehicle[$i]['vRegisteration']);
                                                                                                    if($file_ext == 'is_image'){ ?>
