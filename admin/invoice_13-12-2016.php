									...
									<div class="panel-body rider-invoice-new">
										<div class="row">
											...
											<div class="col-sm-6 rider-invoice-new-left">
												...
												<div class="col-sm-4">
														<?php echo $langage_lbl_admin['LBL_CAR_TXT_ADMIN'];?> <br /> <b><?=$db_trip[0]['eCarType'];?></b><br/>
												</div>
												<div class="col-sm-4">
											...
											<div class="col-sm-6 rider-invoice-new-right">
												<h4 style="text-align:center;">Fare Breakdown For Ride No :<?= $db_trip[0]['vRideNo'];?></h4><hr/>
