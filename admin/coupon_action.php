      ...
      <div class="body-div">
        <div class="form-group"> <span style="color: red;font-size: small;" id="coupon_status"></span>
          ...
          <div class="alert alert-success alert-dismissable">
            ...
            Promo Code Updated successfully. </div>
          <br/>
          <?} ?>
          <? if ($success == 2) {?>
          ...
          <div class="alert alert-danger alert-dismissable">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">x</button>
            "Percentage Value Between 1 to 100. </div>
          <br/>
          <?} ?>
          <form method="post" action="" enctype="multipart/form-data" class="">
            ...
            <div class="row coupon-action-n1">
              ...
              <div class="col-lg-6">
                <input type="text" class="form-control" name="vCouponCode" onBlur=" validate_coupon(this.value)"  id="vCouponCode" value="<?= $vCouponCode; ?>" placeholder="Coupon Code" required>
                <a style="margin: 0 !important;" class="btn btn-sm btn-info" onClick="randomStringToInput(this)">Generate Coupon Code</a> </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <textarea name="tDescription" rows="5" cols="40" class="form-control" id="tDescription" placeholder="Description" required><?=$tDescription;?>
</textarea>
              </div>
            </div>
            <div class="row coupon-action-n2">
              ...
              <div class="col-lg-6">
                <input type="number" class="form-control" name="fDiscount" min="0"  id="fDiscount" value="<?= $fDiscount; ?>" placeholder="Discount" required>
                <select id="eType" name="eType" onChange="coupon(this.value)" class="form-control">
                  <option value="cash" <?php if($db_data[0]['eType'] == "cash"){ ?>selected <?php }?> >$</option>
            ...
            <div class="row" id="date1" style="display:none;">
              ...
              <div class="col-lg-6">
                <input type="text" style="float: left;margin-right: 10px; width:45% " class="form-control" name="dActiveDate"  id="dActiveDate" value="<?= $dActiveDate ?>" placeholder="Activation Date" >
              </div>
            </div>
            <div class="row" id="date2" style="display:none;">
              ...
              <div class="col-lg-6">
                <input type="text" style="float: left;margin-right: 10px; width:45% " class="form-control" name="dExpiryDate" value="<?= $dExpiryDate ?>"  id="dExpiryDate" placeholder="Expiry Date">
              </div>
            </div>
            <div class="row coupon-action-n3">
              ...
              <div class="col-lg-6">
                <input type="number" min="0" id="iUsageLimit" value="<?= $iUsageLimit ?>"  name="iUsageLimit"  title="Usage Limit" class="form-control"/>
              </div>
            </div>
            <div class="row coupon-action-n3">
              <div class="col-lg-12">
            ...
            <div class="row coupon-action-n4">
              <div class="col-lg-12">
                <input type="submit" class="save btn-info" name="submit" id="submit" value="<?= $action; ?> PromoCode"  >
              </div>
            </div>
          </form>
        </div>
