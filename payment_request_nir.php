			...
			<div class="page-contant-inner">
				...
				<div class="trips-table">
					<div class="payment-tabs">
						<ul>
							<li><a href="javascript:void(0);" onClick="getReview('<?=$langage_lbl['LBL_RECENT_RIDE']; ?>');" class="<?=$class1; ?>">Unsettelled</a></li>
							<li><a href="javascript:void(0);" onClick="getReview('<?=$langage_lbl['LBL_PAID_TRIP']; ?>');" class="<?=$class3; ?>">Settelled</a></li>
						</ul>
					</div>
										  ...
										  {									  
											  ...
											  $paymentmode = $db_dtrip[$i]['vTripPaymentMode'];
												...
												<tr class="gradeA">
													...
													<td class="center"><a href="invoice.php?iTripId=<?=$db_dtrip[$i]['iTripId']?>"><img src="assets/img/invoice1.png" ></a>
														<?/* if($vstatus=='Yes')
															{
